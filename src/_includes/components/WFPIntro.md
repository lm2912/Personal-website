...
You can read more about some assumptions I made, the benchmarking setup, and answers to some common questions in the [Introduction]({% postUrl "writing-faster-python-intro" %}) article. And you can find most of the code examples in [this](https://github.com/lukemccrone/blog-resources/tree/master/writing-faster-python) repository.
